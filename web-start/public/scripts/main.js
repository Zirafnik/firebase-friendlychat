...
function saveMessage(messageText) {
  ...
  }).catch((error) => console.log('Error writing new message to database', error));
}
...
function saveImageMessage(file) {
  ...
  }).catch((err) => console.error('There was an error uploading a file to Cloud Storage:', err));
}
...
function requestNotificationsPermissions() {
  console.log('Requesting notificatioins permission...');
